...
class VideoController extends ApiController {
	...
	|
    */
    public $table = 'grv_video';
    public $primary_key = 'video_id';
	public $list_column = array('video_list_id','name', 'author', 'description');
	...
	public function get()
	{
		...
		if (isset($attr['video_id']) && $attr['video_id'] != '') {
			$q.= ' AND video_id = '.replace_quote($attr['video_id']);
		}
	...
	public function get_list_with_stock()
	{
		...
		$q = '
        SELECT ar.article_stock_id, a.video_id, a.site_id, a.article ,a.customer_article, a.description, a.customer_article_description, a.uom, a.conversion_value, a.safety_stock, a.price, a.price_mf,
        ...
        if (isset($attr['export_column'])) {
            $q = '
            SELECT ar.article_stock_id, a.video_id, a.site_id, a.article ,a.customer_article, a.description, a.customer_article_description, a.uom, a.conversion_value, a.safety_stock, 
        ...
        LEFT JOIN ms_article_stock ar USING(video_id)
        WHERE 1 
        HAVING 1';
	...
	public function get_list_export()
	{
		...
		$q.= ' LEFT JOIN ms_article_place artp ON art.video_id = artp.video_id';
		$q.= ' WHERE 1';
	...
	public function get_list_dropdown()
	{
		...
		$q = 'SELECT video_id, article, site_id FROM ' . $this->table . ' 
