...
class EmergencyLogController extends ApiController {
    ...
    */
    ...
    public $list_column = array('site_id','emergency_button','pressed', 'status', 'created_at', 'created_by','created_ip','updated_at','updated_by','updated_ip');
