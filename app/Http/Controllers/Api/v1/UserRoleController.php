...
class UserRoleController extends ApiController {
    ...
    */
	...
	public function get_list()
	{
		...
		$q = '
        SELECT ur.user_role_id, ur.role_id, r.role_name, ur.user_id, u.user_code, u.email, CONCAT(u.firstname," ",u.lastname) as fullname , ur.status
        FROM ' . $this->table . ' ur
	...
	public function get_list_user(){
		...
		if (isset($attr['filter']) && $attr['filter'] != '') 
		{
			...
			if (isset($attr['user_code']) && $attr['user_code'] != '') {
				$q.= ' AND user_code = '.replace_quote($attr['user_code']);
            }
			...
			if (isset($attr['email']) && $attr['email'] != '') {
				$q.= ' AND email = '.replace_quote($attr['email']);
			}
		}
