...
use App\Models\LogActivityChamberModel;

class LogActivityChamberController extends ApiController {
    ...
    */
    ...
    public $list_column = array('site_id','menu','data','remark','chamber_sync_flag', 'created_at','created_by','created_ip');
