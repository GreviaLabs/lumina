...
class ArticleController extends ApiController {
    ...
    */
	...
	public $list_column = array('article_id','site_id', 'article', 'customer_article' ,'description','customer_article_description','uom','conversion_value','safety_stock','column','rack','row','price','price_mf','chamber_sync_flag','field_sync', 'status', 'created_at', 'created_by','created_ip','updated_at','updated_by','updated_ip','art_source');
	...
	public function get_list_with_stock()
	{
		...
		$q = '
        SELECT ar.article_stock_id, a.article_id, a.site_id, a.article ,a.customer_article, a.description, a.customer_article_description, a.uom, a.conversion_value, a.safety_stock, a.price, a.price_mf,
        ...
        if (isset($attr['export_column'])) {
            $q = '
            SELECT ar.article_stock_id, a.article_id, a.site_id, a.article ,a.customer_article, a.description, a.customer_article_description, a.uom, a.conversion_value, a.safety_stock, 
        ...
        LEFT JOIN ms_article_stock ar USING(article_id)
        WHERE 1 
        HAVING 1';
    ...
    public function get_list()
	{
		...
		$q = '
        SELECT a.article_id, a.site_id, a.article, a.customer_article, a.description, a.customer_article_description, uom, conversion_value, safety_stock, max_stock, price, a.status, a.chamber_sync_flag,
	...
	public function get_list_export()
	{
		...
		$q.= ' LEFT JOIN ms_article_place artp ON art.article_id = artp.article_id';
		$q.= ' WHERE 1';
	...
	public function get_list_dropdown()
	{
		...
		$q = 'SELECT article_id, article, site_id FROM ' . $this->table . ' 
