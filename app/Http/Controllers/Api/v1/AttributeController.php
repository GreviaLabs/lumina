...
class AttributeController extends ApiController {
	...
	|
    */
    public $table = 'ms_attribute';
    public $primary_key = 'attribute_id';
	public $list_column = array('attribute_id','attribute_name','chamber_sync_flag','field_sync', 'status', 'created_at', 'created_by','created_ip','updated_at','updated_by','updated_ip');
	...
	public function get()
	{
		...
		if (isset($attr['attribute_id']) && $attr['attribute_id'] != '') {
			$q.= ' AND attribute_id = '.$attr['attribute_id'];
		}
	...
	public function get_list_dropdown()
	{
		...
		$q = 'SELECT attribute_id, attribute_name FROM ' . $this->table . ' 
