...
class EmergencyLogSyncController extends SyncController {
	...
	|
    */
    public $table = 'ms_emergency_log';
    public $primary_key = 'emergency_log_id';
    public $list_column = array('site_id','emergency_button','pressed', 'status', 'field_sync', 'created_at', 'created_by','created_ip','updated_at','updated_by','updated_ip');
	...
	public function get()
	{
		...
		if (isset($attr['emergency_log_id']) && $attr['emergency_log_id'] != '') {
			$q.= ' AND emergency_log_id = '.$attr['emergency_log_id'];
		}
