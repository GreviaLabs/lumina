...
class LogActivityChamberSyncController extends SyncController {
	...
	|
    */
    public $table = 'log_activity_chamber';
    public $primary_key = 'log_id';
    public $list_column = array('site_id','menu', 'data', 'remark','dashboard_sync_flag','last_sync','created_at', 'created_by','created_ip');
	...
	public function save_bulk()
	{
		...
		// Sample data : [{"site_id":"SZ24","menu":"ayam"},{"site_id":"SZ20","menu":"sugoi"}]
