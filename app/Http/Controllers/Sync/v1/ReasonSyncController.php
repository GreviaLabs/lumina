...
class ReasonSyncController extends SyncController {
    ...
    */
    ...
    public $list_column = array('reason_id','reason_value','is_replenish','status','chamber_sync_flag','last_sync', 'created_at', 'created_by','created_ip','updated_at','updated_by','updated_ip');
	...
	{
		$post = $attr = $result = $param_where = $post_reason_id = NULL;
        ...
        if (! isset($post['reason_id'])) $result['message'][] .= 'reason_id must be filled';
